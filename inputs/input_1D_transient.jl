...
E[3,5]=0
E[3,6]=3
E[3,7]=(1)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[3,8]=1
E[3,9]=-1
...
E[4,5]=1
E[4,6]=4
E[4,7]=(25)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[4,8]=0
E[4,9]=1
...
E[5,5]=1+dl
E[5,6]=5
E[5,7]=(1)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[5,8]=20
E[5,9]=-1
...
E[6,5]=1
E[6,6]=6
E[6,7]=(8)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[6,8]=20
E[6,9]=1
