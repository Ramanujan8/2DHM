...
E[17,5]=0
E[17,6]=17
E[17,7]=(1000)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[17,8]=5
E[17,9]=1
...
E[18,5]=1.08
E[18,6]=18
E[18,7]=(1000)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[18,8]=5
E[18,9]=1
...
E[19,5]=1.23
E[19,6]=19
E[19,7]=(1000)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[19,8]=5
E[19,9]=1
...
E[20,5]=1.77
E[20,6]=20
E[20,7]=(25)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[20,8]=5
E[20,9]=1
...
E[21,5]=1.77+dl
E[21,6]=21
E[21,7]=(1)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[21,8]=1
E[21,9]=-1
...
E[22,5]=1.77
E[22,6]=22
E[22,7]=(8)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[22,8]=22
E[22,9]=1
...
E[23,5]=1.27+dl
E[23,6]=23
E[23,7]=(8)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[23,8]=22
E[23,9]=1
...
E[24,5]=1.27
E[24,6]=24
E[24,7]=(1)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[24,8]=1
E[24,9]=-1
...
E[25,5]=1
E[25,6]=25
E[25,7]=(1000)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[25,8]=5
E[25,9]=1
...
E[26,5]=1
E[26,6]=26
E[26,7]=(1000)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[26,8]=5
E[26,9]=1
...
E[27,5]=1.08+dl
E[27,6]=27
E[27,7]=(1000)*2/dl #Assign as (h)*dl/2 if h is convection coef.
E[27,8]=5
E[27,9]=1
